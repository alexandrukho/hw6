            ...
            <div class="container">
                <header class="header">
                    ...
                    <div class="header__menu">
                        <nav class="nav">
                            <ul class="nav__list">
                                <li class="nav__item"><a class="nav__link" href="about-us.php">о нас</a>
                                </li>
                ...
                <div class="hero__container">
                    <div class="hero__content">
                        <div class="hero__left"><img class="hero__img" src="./images-new/new-burger.png" alt=""></div>
        ...
        <section class="section order">
            <div class="container">
                ...
                <div class="order__form">
                    <form class="order__form-tag" id="order-form" action="delivery.php" method="post">
                            ...
                            <div class="order__form-buttons">
                                <div class="order__form-row">
                                    <label class="order__radio">
                                        <input class="order__radio-elem" name="payment" type="radio" value="odd money">
                                        <div class="order__radio-fake"></div>
                                        <div class="order__radio-title">Потребуется сдача</div>
                                    </label>
                                    <label class="order__radio">
                                        <input class="order__radio-elem" name="payment" type="radio" value="card pay">
                                        <div class="order__radio-fake"></div>
                                ...
                                <div class="g-recaptcha" data-sitekey="6LfvTzoUAAAAAMcl-SRnClsmNEfWOjxDZCQhyIY6"></div>
                                <div class="order__form-row">
